...
##### e1
e1 <- read.csv("C:/Users/user/Desktop/2023_47/U_A1_47주차.csv", header = T, encoding = "UTF-8", colClasses = "character")
...
##### e2
e2 <- read.csv("C:/Users/user/Desktop/2023_47/U_A22_47주차(사업자).csv", header = T, encoding = "UTF-8", colClasses = "character")
...
##### e3
e3 <- read.csv("C:/Users/user/Desktop/2023_47/U_A333_47주차.csv",header = T, encoding = "UTF-8", colClasses = "character")
...
##### e4
e4 <- read.csv("C:/Users/user/Desktop/2023_47/U_A4444_47주차.csv", header = T, encoding = "UTF-8", colClasses = "character")
...
##### e5
e5 <- read.csv("C:/Users/user/Desktop/2023_47/U_A55555_47주차(사업자).csv", header=T, encoding="UTF-8", colClasses="character")
...
write.csv(c, "C:/Users/user/Desktop/2023_대체_47/중앙값.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(e4_m_all, "C:/Users/user/Desktop/2023_대체_47/중앙값자료.csv", row.names = F, fileEncoding = "euc-kr")
...
table(e2_notnull$snb2306) # 연계여부확인(if 연계 != 0, pass, 연계)

##### 저장(검토용)
write.csv(e1_dom_final, "C:/Users/user/Desktop/2023_대체_47/E1_47주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(e2_dom_final, "C:/Users/user/Desktop/2023_대체_47/E2_47주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(e3_dom_final, "C:/Users/user/Desktop/2023_대체_47/E3_47주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장
write.csv(e1_dom_final, "C:/Users/user/Desktop/2023_대체_47/E1_47주차_(지역).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e1_dom_final, "C:/Users/user/Desktop/2023_대체_47/E1_47주차_한글.csv", row.names = F, fileEncoding = "euc-kr")

write.csv(e2_dom_final, "C:/Users/user/Desktop/2023_대체_47/E2_47주차_(지역업종별).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e2_dom_final, "C:/Users/user/Desktop/2023_대체_47/E2_47주차_한글.csv", row.names = F, fileEncoding = "euc-kr")

write.csv(e3_dom_final, "C:/Users/user/Desktop/2023_대체_47/E3_47주차_(지역학력).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e3_dom_final, "C:/Users/user/Desktop/2023_대체_47/E3_47주차_한글.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장(검토용)
write.csv(e4_join_final, "C:/Users/user/Desktop/2023_대체_47/E4_47주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장
write.csv(e4_join_final, "C:/Users/user/Desktop/2023_대체_47/E4_47주차_(전체학력).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e4_join_final, "C:/Users/user/Desktop/2023_대체_47/E4_47주차_한글.csv", row.names = F, fileEncoding = "euc-kr")
...
write.csv(e5_join_final, "C:/Users/user/Desktop/2023_대체_47/E5_47주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
...
sanup <- sanup[!duplicated(sanup),] #중복제거
rownames(sanup) <- NULL
sanup$snb2306 <- ifelse(sanup$snb2306 == "", NA, sanup$snb2306)

##### 연계 확인
e5_notnull$사업자번호 <- gsub('-', '', e5_notnull$사업자번호)

e5_notnull <- left_join(e5_notnull, sanup, by = c("사업자번호"="BIZRNO"))
table(e5_notnull$snb2306) # 연계여부확인(if 연계 != 0, pass, 연계)

##### 연계
e5_join_final$사업자번호 <- gsub('-', '', e5_join_final$사업자번호)
e5_fin_sanup <- left_join(e5_join_final, sanup, by = c("사업자번호"="BIZRNO"))
table(e5_fin_sanup$snb2306)
e5_fin_sanup$산업분류코드 <- ifelse(e5_fin_sanup$산업분류코드 == "", e5_fin_sanup$snb2306, e5_fin_sanup$산업분류코드)
...
e5_fin_sanup <- e5_fin_sanup %>% select(-snb2306)
...
##### 저장
write.csv(e5_final, "C:/Users/user/Desktop/2023_대체_47/E5_47주차_(전체업종별).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e5_final, "C:/Users/user/Desktop/2023_대체_47/E5_47주차_한글.csv", row.names = F, fileEncoding = "euc-kr")
