...
##### e1
e1 <- read.csv("C:/Users/user/Desktop/2023_33/U_A1_33주차.csv", header = T, encoding = "UTF-8", colClasses = "character")
...
##### e2
e2 <- read.csv("C:/Users/user/Desktop/2023_33/U_A22_33주차(사업자).csv", header = T, encoding = "UTF-8", colClasses = "character")
...
##### e3
e3 <- read.csv("C:/Users/user/Desktop/2023_33/U_A333_33주차.csv",header = T, encoding = "UTF-8", colClasses = "character")
...
##### e4
e4 <- read.csv("C:/Users/user/Desktop/2023_33/U_A4444_33주차.csv", header = T, encoding = "UTF-8", colClasses = "character")
...
##### e5
e5 <- read.csv("C:/Users/user/Desktop/2023_33/U_A55555_33주차(사업자).csv", header=T, encoding="UTF-8", colClasses="character")
...
write.csv(c, "C:/Users/user/Desktop/2023_대체_33/중앙값.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(e4_m_all, "C:/Users/user/Desktop/2023_대체_33/중앙값자료.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장(검토용)
write.csv(e1_dom_final, "C:/Users/user/Desktop/2023_대체_33/E1_33주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(e2_dom_final, "C:/Users/user/Desktop/2023_대체_33/E2_33주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(e3_dom_final, "C:/Users/user/Desktop/2023_대체_33/E3_33주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장
write.csv(e1_dom_final, "C:/Users/user/Desktop/2023_대체_33/E1_33주차_(지역).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e1_dom_final, "C:/Users/user/Desktop/2023_대체_33/E1_33주차_한글.csv", row.names = F, fileEncoding = "euc-kr")

write.csv(e2_dom_final, "C:/Users/user/Desktop/2023_대체_33/E2_33주차_(지역업종별).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e2_dom_final, "C:/Users/user/Desktop/2023_대체_33/E2_33주차_한글.csv", row.names = F, fileEncoding = "euc-kr")

write.csv(e3_dom_final, "C:/Users/user/Desktop/2023_대체_33/E3_33주차_(지역학력).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e3_dom_final, "C:/Users/user/Desktop/2023_대체_33/E3_33주차_한글.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장(검토용)
write.csv(e4_join_final, "C:/Users/user/Desktop/2023_대체_33/E4_33주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장
write.csv(e4_join_final, "C:/Users/user/Desktop/2023_대체_33/E4_33주차_(전체학력).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e4_join_final, "C:/Users/user/Desktop/2023_대체_33/E4_33주차_한글.csv", row.names = F, fileEncoding = "euc-kr")
...
write.csv(e5_join_final, "C:/Users/user/Desktop/2023_대체_33/E5_33주차_검토.csv", row.names = F, fileEncoding = "euc-kr")
...
##### 저장
write.csv(e5_final, "C:/Users/user/Desktop/2023_대체_33/E5_33주차_(전체업종별).csv", row.names = F, fileEncoding = "UTF-8")
write.csv(e5_final, "C:/Users/user/Desktop/2023_대체_33/E5_33주차_한글.csv", row.names = F, fileEncoding = "euc-kr")
