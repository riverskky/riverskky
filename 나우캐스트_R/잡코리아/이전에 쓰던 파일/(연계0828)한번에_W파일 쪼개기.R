...
기반 <- read_excel("C:/Users/user/Desktop/2023_33/W33_지역기반.xlsx") 
미기반 <- read_excel("C:/Users/user/Desktop/2023_33/W33_지역미기반.xlsx")
...
# csv파일로 저장
write.csv(A1, "C:/Users/user/Desktop/2023_33/A1_33주차.csv", row.names = F, fileEncoding = "euc-kr") # 검토용
write.csv(A1, "C:/Users/user/Desktop/2023_33/U_A1_33주차.csv", row.names = F, fileEncoding = "UTF-8") # 업로드용

write.csv(A2, "C:/Users/user/Desktop/2023_33/A22_33주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A2, "C:/Users/user/Desktop/2023_33/U_A22_33주차.csv", row.names = F, fileEncoding = "UTF-8") # 사업자등록번호 제외
write.csv(A2_사업자, "C:/Users/user/Desktop/2023_33/U_A22_33주차(사업자).csv", row.names = F, fileEncoding = "UTF-8") # 중앙값 대체할 때 이용

write.csv(A3, "C:/Users/user/Desktop/2023_33/A333_33주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A3, "C:/Users/user/Desktop/2023_33/U_A333_33주차.csv", row.names = F, fileEncoding = "UTF-8")

write.csv(A4, "C:/Users/user/Desktop/2023_33/A4444_33주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A4, "C:/Users/user/Desktop/2023_33/U_A4444_33주차.csv", row.names = F, fileEncoding = "UTF-8")

write.csv(A5, "C:/Users/user/Desktop/2023_33/A55555_33주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A5, "C:/Users/user/Desktop/2023_33/U_A55555_33주차.csv", row.names = F, fileEncoding = "UTF-8") # 사업자등록번호 제외
write.csv(A5_사업자, "C:/Users/user/Desktop/2023_33/U_A55555_33주차(사업자).csv", row.names = F, fileEncoding = "UTF-8") # 중앙값 대체할 때 이용
