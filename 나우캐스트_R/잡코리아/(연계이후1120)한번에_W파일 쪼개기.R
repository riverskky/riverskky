...
기반 <- read_excel("C:/Users/user/Desktop/2023_49/W49_지역기반.xlsx") 
미기반 <- read_excel("C:/Users/user/Desktop/2023_49/W49_지역미기반.xlsx")
...
names(미기반)[1] <- "등록일자"  # '채용공고게재시작일시 (주)'로 되어있는 경우 수정
names(기반)[1] <- "등록일자"

names(기반)[2] <- "광역시도" # 47주차 때문에 추가함
names(기반)[3] <- "시군구"   # '채용공고시군구명'으로 되어있는 경우 수정
...
# csv파일로 저장
write.csv(A1, "C:/Users/user/Desktop/2023_49/A1_49주차.csv", row.names = F, fileEncoding = "euc-kr") # 검토용
write.csv(A1, "C:/Users/user/Desktop/2023_49/U_A1_49주차.csv", row.names = F, fileEncoding = "UTF-8") # 업로드용

write.csv(A2, "C:/Users/user/Desktop/2023_49/A22_49주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A2, "C:/Users/user/Desktop/2023_49/U_A22_49주차.csv", row.names = F, fileEncoding = "UTF-8") # 사업자등록번호 제외
write.csv(A2_사업자, "C:/Users/user/Desktop/2023_49/U_A22_49주차(사업자).csv", row.names = F, fileEncoding = "UTF-8") # 중앙값 대체할 때 이용

write.csv(A3, "C:/Users/user/Desktop/2023_49/A333_49주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A3, "C:/Users/user/Desktop/2023_49/U_A333_49주차.csv", row.names = F, fileEncoding = "UTF-8")

write.csv(A4, "C:/Users/user/Desktop/2023_49/A4444_49주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A4, "C:/Users/user/Desktop/2023_49/U_A4444_49주차.csv", row.names = F, fileEncoding = "UTF-8")

write.csv(A5, "C:/Users/user/Desktop/2023_49/A55555_49주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A5, "C:/Users/user/Desktop/2023_49/U_A55555_49주차.csv", row.names = F, fileEncoding = "UTF-8") # 사업자등록번호 제외
write.csv(A5_사업자, "C:/Users/user/Desktop/2023_49/U_A55555_49주차(사업자).csv", row.names = F, fileEncoding = "UTF-8") # 중앙값 대체할 때 이용
