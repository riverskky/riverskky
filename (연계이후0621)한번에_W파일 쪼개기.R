...
기반 <- read_excel("C:/Users/user/Desktop/2023_28/W28_지역기반.xlsx") 
미기반 <- read_excel("C:/Users/user/Desktop/2023_28/W28_지역미기반.xlsx")
...
# (4) 산업연계 코드
head(sanup) #  num, BIZRNO, snb2204
## BIZRNO는 사업자등록번호, snb2204는 산업연계코드입니다.
...
A2 <- A2 %>% group_by(등록일자, 광역시도, 시군구, snb2204, 모집인원, 사업자등록번호) %>% dplyr::summarise(n=sum(공고수)) %>% as.data.frame() 

colnames(A2) # "등록일자"  "광역시도"  "시군구"  "snb2204"  "모집인원"  "사업자등록번호"  "n"
...
A5 <- A5 %>% group_by(등록일자, snb2204, 모집인원, 사업자등록번호) %>% dplyr::summarise(n=sum(공고수)) %>% as.data.frame() 

head(A5)

colnames(A5) # "등록일자"  "snb2204"  "모집인원"  "사업자등록번호"  "n"
...
# csv파일로 저장
write.csv(A1, "C:/Users/user/Desktop/2023_28/A1_28주차.csv", row.names = F, fileEncoding = "euc-kr") # 검토용
write.csv(A1, "C:/Users/user/Desktop/2023_28/U_A1_28주차.csv", row.names = F, fileEncoding = "UTF-8") # 업로드용

write.csv(A2, "C:/Users/user/Desktop/2023_28/A22_28주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A2, "C:/Users/user/Desktop/2023_28/U_A22_28주차.csv", row.names = F, fileEncoding = "UTF-8") # 사업자등록번호 제외
write.csv(A2_사업자, "C:/Users/user/Desktop/2023_28/U_A22_28주차(사업자).csv", row.names = F, fileEncoding = "UTF-8") # 중앙값 대체할 때 이용

write.csv(A3, "C:/Users/user/Desktop/2023_28/A333_28주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A3, "C:/Users/user/Desktop/2023_28/U_A333_28주차.csv", row.names = F, fileEncoding = "UTF-8")

write.csv(A4, "C:/Users/user/Desktop/2023_28/A4444_28주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A4, "C:/Users/user/Desktop/2023_28/U_A4444_28주차.csv", row.names = F, fileEncoding = "UTF-8")

write.csv(A5, "C:/Users/user/Desktop/2023_28/A55555_28주차.csv", row.names = F, fileEncoding = "euc-kr")
write.csv(A5, "C:/Users/user/Desktop/2023_28/U_A55555_28주차.csv", row.names = F, fileEncoding = "UTF-8") # 사업자등록번호 제외
write.csv(A5_사업자, "C:/Users/user/Desktop/2023_28/U_A55555_28주차(사업자).csv", row.names = F, fileEncoding = "UTF-8") # 중앙값 대체할 때 이용
